...
public class Distances3 : MonoBehaviour
{
    ...
    void Update()
    {
        lineRenderer.SetPosition(0, object4.transform.position);
    ...
    {
        return Vector3.Distance(object4.transform.position, object2.transform.position);
    }
    private float CalculateDistanceXYPlane()
    {
        Vector2 v1 = new Vector2(object4.transform.position.x, object4.transform.position.y);
